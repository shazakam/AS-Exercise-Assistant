...
class DataProcessor:
    ...
    def __init__(self, videoFile, db):
    ...
    def send_lower_data(self,angles, rep_times):
        ...
        self.db.collection(u'RESULTS').document(u'lower_results').set(data)
    ...
    def analyse_video_lie(self):
        ...
        video_result = cv2.VideoWriter('myVideo1.mp4', fourcc,fps,(width,height))
        ...
        with self.mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            ...
            while cap.isOpened():
                ...
                try:
                    ...
                    if body_language_class != "Lie_Down":
                        ...
                        left_angle = self.get_angle(left_ankle,left_knee,left_hip)
                        ...
                        right_angle = self.get_angle(right_ankle,right_knee,right_hip)
                        
                        if right_angle < 90 and left_angle < 90:
                            cv2.putText(image, "PUT A LEG DOWN"
                                    ,(width - 450,40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                        elif right_angle < 90 and left_angle > 90 or right_angle > 90 and left_angle < 90:
                            cv2.putText(image, "GOOD TRY BOTH LEGS"
                                    ,(width - 450,40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                        else:
                            cv2.putText(image, "AMAZING"
                                    ,(width - 450,40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        ...
        with self.mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            ...
            while cap.isOpened():
                ...
                try:
                    ...
                    cv2.putText(image, 'Class'
                                    , (800,25), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                    ...
                    if body_language_class != "Lower_Stretch":
                        ...
                        cv2.putText(image, "Bad Form"
                                    , (800,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                        
                        cv2.putText(image, "Please get into position"
                                        ,(width//2-200,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                    else:
                        cv2.putText(image, str(round(body_language_prob[np.argmax(body_language_prob)],2))
                                    , (10,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                        cv2.putText(image, body_language_class.split('_')[0]
                        ...
                        if right_shoulder_prob > left_shoulder_prob:
                            ...
                            if angle > 160:
                                ...
                                cv2.putText(image, "PUSH LEFT LEG FORWARD"
                                    ,(width//2,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                                ...
                                if in_rep:
                                    cv2.putText(image, "GOOD JOB",(width//2,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                                    angles.append(angle)
                            ...
                            if angle > 160:
                                cv2.putText(image, "PUSH RIGHT FORWARD"
                                    ,(width//2-100,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
            ...
            if in_rep == True:
                rep_times.append(time.time()-timer)
            self.send_lower_data(angles=angles, rep_times=rep_times)
